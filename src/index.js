...
exports.mailTemplate = function mailTemplate(editor){ 
...
exports.handleBarPlugin  = function handleBarPlugin(editor){ 
  editor.DomComponents.addType('handleBar-Plugin', {
    model: {
      defaults: {
        textable: 1,
