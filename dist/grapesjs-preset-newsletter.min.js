  ...
  return (function(t) {
    ...
    function(t, e) {
      ...
      function a() {
        g &&
          p &&
          ((g = !1), p.length ? (d = p.concat(d)) : (v = -1), d.length && s());
      }
      function s() {
        if (!g) {
          var t = i(a);
    ...
    function(t, e, r) {
      ...
      (e.isTag = function(t) {
        ...
        (e.domEach = function(t, e) {
          for (var r = 0, n = t.length; r < n && !1 !== e.call(t, r, t[r]); )
            ++r;
          return t;
        }),
          ...
          (e.update = function(t, e) {
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              o &&
                ...
                e
                  ? ((n.prev = t[r - 1] || null), (n.next = t[r + 1] || null))
                  : (n.prev = n.next = null),
                e && "root" === e.type
    ...
    function(t, e, r) {
      ...
      (function(t) {
        ...
        function N(t, e, r, n, i) {
          return (
            i || I(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
        ...
        function U(t, e, r, n, i) {
          return (
            i || I(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
        ...
        s = (t.exports = function(t, e, r, a) {
          return this instanceof s
            ? ((this.options = o.defaults(a || {}, this.options)),
              t
                ? (r &&
                    ("string" == typeof r && (r = n(r, this.options)),
    ...
    function(t, e, r) {
      ...
      (function(e, n, i) {
        ...
        function l(t) {
          if (((O = O || r(2)), !(R.call(l, this) || this instanceof O)))
            return new l(t);
          ...
          for (var i in t)
            (r = t[i]),
              ...
              !r && f[i]
                ? (n += i)
                : (n +=
                    i + '="' + (e.decodeEntities ? l.encodeXML(r) : r) + '"');
          return n;
        }
      }
      function i(t, e) {
    ...
    function(t, e, r) {
      (function(e) {
        ...
        function b(t, e, r) {
          function n() {
            return (this && this !== _t && this instanceof n ? o : t).apply(
              i ? r : this,
              arguments
            );
          }
        ...
        function m(t, e, n) {
          function i() {
            for (var a = arguments.length, s = Array(a), u = a, c = j(i); u--; )
              s[u] = arguments[u];
        ...
        function _(t, e, r, n, i, o, a, s, c, l) {
          function h() {
            for (var k = arguments.length, E = Array(k), A = k; A--; )
              E[A] = arguments[A];
            if (m)
              var T = j(h),
                O = u(E, T);
        ...
        var o = a(t, n),
          u = function(t, e, r, a) {
            return this instanceof u
              ? ((a = s.defaults(a || {}, n)), i.call(this, t, e, r || o, a))
              : new u(t, e, r, a);
          };
        return (
      ...
      var s = r(4),
        ...
        x = {
          ...
          button: function(t) {
            var e = d(t);
            return (
              "button" === e || ("input" === e && "button" === g(t, "type"))
            );
          },
          input: function(t) {
            var e = d(t);
      ...
      (e.Selector = o),
        ...
        (e.parseCSS = function(t) {
          for (
            ...
            if ("rule" == r[o].type)
              for (
                var s = r[o], u = s.selectors, c = 0, l = u.length;
                c < l;
                c++
              )
    ...
    function(t, e, r) {
      ...
      (a.prototype._stateText = function(t) {
        ...
        (a.prototype._stateInCloseingTagName = function(t) {
          (">" === t || n(t)) &&
            (this._emitToken("onclosetag"), (this._state = y), this._index--);
        }),
        ...
        (a.prototype._parseLegacyEntity = function() {
          ...
          for (e > 6 && (e = 6); e >= 2; ) {
            ...
            if (c.hasOwnProperty(r))
              return (
                this._emitPartial(c[r]), void (this._sectionStart += e + 1)
              );
            e--;
          }
        }),
        ...
        function E(t, e, r) {
          ...
          return (
            t < e.head.data.length
              ...
              : (n =
                  t === e.head.data.length ? e.shift() : r ? A(t, e) : T(t, e)),
            n
          );
        }
        function A(t, e) {
    ...
    function(t, e) {
      ...
      function s(t, e) {
        return (
          ...
          function() {
            for (
              var n = arguments, i = -1, o = C(n.length - e, 0), a = Array(o);
              ++i < o;
    ...
    function(t, e) {
      ...
      function u(t, e) {
        return (
          ...
          function() {
            for (
              var n = arguments, i = -1, o = B(n.length - e, 0), a = Array(o);
              ++i < o;
            ...
            return 0 === i
              ...
              ? ((n = n.toLowerCase()),
                function(e) {
                  var a = o(e, r);
                  return (
                    null != a && a.substr(0, i).toLowerCase() === n && t(e)
                  );
                })
              : function(e) {
                  var a = o(e, r);
          ...
          switch ((i && a(d, e()), d)) {
            ...
            case ";":
              switch (e()) {
                ...
                case "before-value":
                case "value":
                  g.trim().length > 0 && ((x.value = g.trim()), f()),
                    c("before-name");
                  break;
                case "value-paren":
                  g += d;
            ...
            case "}":
              switch (e()) {
                ...
                case "selector":
                  ...
                  y > 0 && "at-group" === e(1) && (h("at-group-end"), f()),
                    y > 1 && s(),
                    y > 0 && (y -= 1);
                  break;
                case "double-string":
            ...
            case "'":
              switch (e()) {
                ...
                case "before-at-value":
                  c("at-value"),
                    u('"' === d ? "double-string" : "single-string");
                  break;
                case "before-value":
    ...
    function(t, e, r) {
      ...
      e.default = i.default.plugins.add("gjs-preset-newsletter", function(
        t,
        e
      ) {
        var n = e || {},
        ...
        r(48)(n),
          ...
          t.on("change:selectedComponent", function() {
            ...
            if ((!e || !e.get("active")) && t.editor.get("selectedComponent")) {
              ...
              r.set("attributes", { title: a.openSmBtnTitle }),
                r && r.set("active", 1);
            }
          }),
          ...
          t.on("load", function() {
            ...
            e.set("attributes", { title: a.openBlocksBtnTitle }),
              e && e.set("active", 1);
          });
      });
    },
            ...
            e.each(function(e) {
              if ("image" === e.get("type")) {
                ...
                r
                  ...
                  : "##" !== n &&
                    (e.set("src_bkp", e.get("src")), e.set("src", "##"));
              }
                  ...
                  if ((s.setTitle(t.modalTitleImport), !u)) {
                    ...
                    if (t.modalLabelImport) {
                      ...
                      (l.className = o + "import-label"),
                        (l.innerHTML = t.modalLabelImport),
                        i.appendChild(l);
                    }
                    i.appendChild(c),
                      i.appendChild(n),
                  ...
                  if ((u.setTitle(e.modalTitleExport), !c)) {
                    ...
                    if (e.modalLabelExport) {
                      ...
                      (f.className = o + "export-label"),
                        (f.innerHTML = e.modalLabelExport),
                        i.appendChild(f);
                    }
                    i.appendChild(l),
                      n.init(l),
              ...
              return (
                Object.keys(n).forEach(function(t) {
                  ...
                  r = r.replace(i, function(t, r) {
                    return (
                      e.push(t), "JUICE_CODE_BLOCK_" + (e.length - 1) + "_"
                    );
                  });
                }),
                r
    ...
    function(t, e, r) {
      ...
      function a(t) {
        ...
        return (
          2 === a &&
            ((e = (f[t.charCodeAt(l)] << 2) | (f[t.charCodeAt(l + 1)] >> 4)),
            (s[u++] = 255 & e)),
          1 === a &&
            ((e =
              (f[t.charCodeAt(l)] << 10) |
      ...
      function s(t) {
        return (
          l[(t >> 18) & 63] + l[(t >> 12) & 63] + l[(t >> 6) & 63] + l[63 & t]
        );
      }
      function u(t, e, r) {
    ...
    function(t, e, r) {
      ...
      function u(t, e) {
        for (var r = [], n = 0, i = e.length; n < i; n++)
          c(e[n]) &&
            (t(e[n]) && r.push(e[n]),
            e[n].children.length > 0 && (r = r.concat(u(t, e[n].children))));
        return r;
      }
      var c = r(6).isTag;
      t.exports = {
    ...
    function(t, e) {
      ...
      e.uniqueSort = function(t) {
        var e,
          ...
          o = t.length;
        for (t = t.slice(); --o > -1; )
          (e = t[o]), (i = t.indexOf(e)) > -1 && i < o && t.splice(o, 1);
        return (
          t.sort(function(t, e) {
            var i = n(t, e);
      ...
      function s(t, e, r) {
        ...
        for (a(0); "" !== e; )
          if (((y = e.charAt(0)), o(y))) (x = !0), a(1);
            ...
            (x && (w.length > 0 && w.push({ type: "descendant" }), (x = !1)),
            "*" === y)
          )
            ...
            if (":" === e.charAt(1)) {
              (e = e.substr(2)),
                w.push({ type: "pseudo-element", name: n().toLowerCase() });
              continue;
            }
            if (
              ((e = e.substr(1)),
              ...
              if (m in g) {
                ...
                if (((e = e.substr(S + 1)), (l = []), (e = s(l, e, r)), S)) {
                  if (e.charAt(0) !== _)
                    throw new SyntaxError("unmatched quotes in :" + m);
                  e = e.substr(1);
                }
                if (")" !== e.charAt(0))
                  throw new SyntaxError(
                    "missing closing parenthesis in :" + m + " " + e
                  );
                e = e.substr(1);
              } else {
                ...
                (l = e.substr(1, j - 2)),
                  ...
                  m in v &&
                    ((_ = l.charAt(0)),
                    _ === l.slice(-1) && _ in b && (l = l.slice(1, -1)),
                    (l = i(l)));
              }
            ...
            if (!c.test(e))
              return (
                w.length && "descendant" === w[w.length - 1].type && w.pop(),
                u(t, w),
                e
              );
            (m = n()),
              (r && ("lowerCaseTags" in r ? !r.lowerCaseTags : r.xmlMode)) ||
                (m = m.toLowerCase()),
    ...
    function(t, e, r) {
      (function(t, r) {
        ...
        function B(t, e, r) {
          ((void 0 === r || ut(t[e], r)) && (void 0 !== r || e in t)) ||
            P(t, e, r);
        }
        function D(t, e, r) {
          var n = t[e];
        ...
        (Rt["[object Float32Array]"] = Rt["[object Float64Array]"] = Rt[
          ...
          (Rt[Et] = Rt["[object Array]"] = Rt["[object ArrayBuffer]"] = Rt[
            "[object Boolean]"
          ] = Rt["[object DataView]"] = Rt["[object Date]"] = Rt[
            "[object Error]"
          ] = Rt[Tt] = Rt["[object Map]"] = Rt["[object Number]"] = Rt[Ct] = Rt[
            "[object RegExp]"
      ...
      (function(t, r) {
        ...
        function y(t) {
          var e = this.__data__,
            r = I(e, t);
          return (
            !(r < 0) && (r == e.length - 1 ? e.pop() : Pe.call(e, r, 1), !0)
          );
        }
        function m(t) {
          var e = this.__data__,
        ...
        function $(t, e, r, n, i, o) {
          ...
          if (p && !f)
            return (
              o || (o = new C()),
              a || rr(t) ? rt(t, e, r, n, i, o) : nt(t, e, c, r, n, i, o)
            );
          if (!(i & Ut)) {
        ...
        function nt(t, e, r, n, i, o, a) {
          switch (r) {
            ...
            case ne:
              return !(
                t.byteLength != e.byteLength || !n(new De(t), new De(e))
              );
            case Ht:
            case Wt:
            case Xt:
        ...
        var Mt = 200,
          ...
          he = /^(?:0|[1-9]\d*)$/,
          pe = {};
        (pe["[object Float32Array]"] = pe["[object Float64Array]"] = pe[
          "[object Int8Array]"
        ] = pe["[object Int16Array]"] = pe["[object Int32Array]"] = pe[
          "[object Uint8Array]"
        ] = pe["[object Uint8ClampedArray]"] = pe["[object Uint16Array]"] = pe[
          "[object Uint32Array]"
        ] = !0),
          (pe[Vt] = pe[$t] = pe[ne] = pe[Ht] = pe[ie] = pe[Wt] = pe[Gt] = pe[
            Yt
          ] = pe[Qt] = pe[Xt] = pe[Zt] = pe[Kt] = pe[te] = pe[ee] = pe[
            "[object WeakMap]"
          ] = !1);
    ...
    function(t, e, r) {
      function n(t, r, n, i) {
        for (var o = []; r && o.length < i; )
          (n && !e.filter.call([r], n, t).length) || o.push(r), (r = r.parent);
        return o;
      }
      var i = r(42),
        o = r(9),
      ...
      (e.filter = l(c.filter)),
        ...
        (e.add = function(t, e) {
          for (
            var r = this._make(t, e), n = s(r.get().concat(this.get())), i = 0;
            i < n.length;
            ++i
          )
            r[i] = n[i];
      ...
      (function(t, r) {
        ...
        function m(t) {
          var e = this.__data__,
            r = N(e, t);
          return (
            !(r < 0) && (r == e.length - 1 ? e.pop() : Me.call(e, r, 1), !0)
          );
        }
        function _(t) {
          var e = this.__data__,
        ...
        function W(t, e, r, n, i, o) {
          ...
          if (p && !f)
            return (
              o || (o = new B()),
              a || nr(t) ? nt(t, e, r, n, i, o) : it(t, e, c, r, n, i, o)
            );
          if (!(i & Ft)) {
        ...
        function it(t, e, r, n, i, o, a) {
          switch (r) {
            ...
            case ie:
              return !(
                t.byteLength != e.byteLength || !n(new qe(t), new qe(e))
              );
            case Wt:
            case Gt:
            case Zt:
        ...
        (de["[object Float32Array]"] = de["[object Float64Array]"] = de[
          ...
          (de[$t] = de[Ht] = de[ie] = de[Wt] = de[oe] = de[Gt] = de[Yt] = de[
            Jt
          ] = de[Xt] = de[Zt] = de[Kt] = de[te] = de[ee] = de[re] = de[
            "[object WeakMap]"
          ] = !1);
      ...
      (function(t, r) {
        ...
        function W(t, e, r, n, i, o) {
          ...
          if (p && !f)
            return (
              o || (o = new B()),
              a || rr(t) ? nt(t, e, r, n, i, o) : it(t, e, c, r, n, i, o)
            );
          if (!(i & Ut)) {
            var d = f && Oe.call(t, "__wrapped__"),
              g = h && Oe.call(e, "__wrapped__");
      ...
      (function(t, r) {
        ...
        function W(t, e, r, n, i, o) {
          ...
          if (p && !f)
            return (
              o || (o = new D()),
              a || rr(t) ? nt(t, e, r, n, i, o) : it(t, e, u, r, n, i, o)
            );
          if (!(i & Ut)) {
            var d = f && Oe.call(t, "__wrapped__"),
              g = h && Oe.call(e, "__wrapped__");
        ...
        d = function(t, e, r, n, i) {
          ...
          for (o = 0, a = n.length; o < a; ++o)
            (u = n[o]),
              ...
              c &&
                s > -1 &&
                (c.children.splice(s, 1), i === c && e > s && l[0]--),
              (u.root = null),
              (u.parent = i),
            ...
            u(this, function(r, n) {
              ...
              if (o) {
                ...
                c < 0 ||
                  ((a =
                    "function" == typeof t[0]
                      ? t[0].call(n, r, i.html(n.children))
                      : t),
    ...
    function(t, e) {
      t.exports = {
        ...
        _where:
          "/Users/artur/Sites/grapesjs-plugins/grapesjs-preset-newsletter/node_modules/juice",
        author: {
          name: "Matt Mueller",
    ...
    function(t, e, r) {
      ...
      function i(t) {
        return (
          ...
          t ? void (this.level += t) : v ? "" : Array(this.level).join(b || "")
        );
      }
      function o(t) {
    ...
    function(t, e, r) {
      ...
      (t.exports = n),
        ...
        (n.prototype.specificity = function() {
          function t(r, n) {
            for (
              var o = n || i(r), a = [e ? 1 : 0, 0, 0, 0], s = [], u = 0;
              u < o.length;
              u++
            ) {
              var c = o[u],
              ...
              if (
                ...
                for (var f = 0; f < l.length; f++)
                  "not" === l[f].name && (s.push(l[f].value), a[3]--);
              }
            }
          ...
          return (
            this.spec || (this.spec = t(this.text, this.parsed())), this.spec
          );
        });
    },
    function(t, e, r) {
      ...
      var l = function(t, e, r, n, i, s, l, f, h, p, d, g, v, b, y, m) {
          var _, w;
          if ((e || !this.length) && ((_ = this[this.length++] = new c()), e))
            return "";
          if (
      ...
      t.exports = function(t) {
          ...
          function u(r) {
            ...
            _.each(function() {
              ...
              if (
                !(
                  i.name &&
                  t.nonVisualElements.indexOf(i.name.toUpperCase()) >= 0
                )
              ) {
                if (f) {
                  var o = "pseudo" + f,
        ...
        function i(t) {
          if (0 !== t.length) {
            ...
            if (e)
              for (var r = 0; r < e.length; r++) if (o(e[r])) return e[r].name;
          }
        }
        function o(t) {
